      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-20 md:mb-28">
          <div>
            ...
            >
              Toronto roots. Global standards.
            </h2>
            <p
              className="about-anim font-inter text-[20px]"
              style={{ color: '#8A8884', lineHeight: 1.6, letterSpacing: '-0.01em' }}
            >
              We're a team of engineers, strategists, and designers who believe technology should serve people — not the other way around. Based in Toronto, we work with clients who want more than a vendor. They want a partner.
            </p>
          </div>
          <div className="about-anim">
            <img
              src="/about-office.jpg"
              alt="MINDRICH Toronto Office"
